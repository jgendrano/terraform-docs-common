...
#### Module Tests Generation (Beta)

Enable module tests generation for your organization. Module test generation allows you to quickly generate Terraform tests for a private registry module. To generate module tests, your organization must be on a Terraform Business or Plus subscription and you must have [permission to manage registry modules](/terraform/cloud-docs/users-teams-organizations/permissions#organization-permissions)
